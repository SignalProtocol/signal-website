  ...
  const steps = [
    {
      ...
      description:
        "Stake or hold $SIGNAL to receive your daily signal quota based on tier level",
    },
    {
      icon: CreditCard,
      step: "02",
      title: "Pay with x402",
      description:
        "Pay tiny amounts in USDC via x402 protocol—signal unlocks instantly",
    },
    {
      icon: LineChart,
      step: "03",
      ...
      description:
        "Trade long or short positions on Drift, Hyperliquid, Jupiter Perps",
    },
    {
      icon: Gift,
      step: "04",
      title: "Track P & L",
      description:
        "Track P&L of your trades based on the entry and exit zones of the signals.",
    },
  ];
  ...
  const signal_pricing = [
    {
      name: "Low Risk",
      leverage: "1x-5x",
      signals: "1 USDC/signal",
      color: "from-green-400 to-emerald-300",
    },
    {
      name: "Medium Risk",
      leverage: "5x-10x",
      signals: "2 USDC/signal",
      color: "from-yellow-300 to-amber-200",
    },
    {
      name: "High Risk",
      leverage: "10x and beyond",
      signals: "3 USDC/signal",
      ...
      <div className="container px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Connect wallet → browse signals → pay with x402 → execute trades
            immediately
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-20">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {tiers.map((tier, index) => (
              ...
              >
                <div
                  className={`text-2xl font-black bg-gradient-to-r ${tier.color} bg-clip-text text-transparent mb-2`}
                >
                  {tier.name}
                </div>
